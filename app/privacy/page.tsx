    ...
    return (
        <div className="w-full h-full flex flex-col">
            ...
            <div className="background-br">
                <motion.div
                    className="w-full h-auto flex max mb-24 p-4 lg:0">
                    <div className="mt-12 flex flex-col gap-4 max-w-2xl min-w-2xl w-full">
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    ...
                                    <div className="leading-7 mt-2">
                                        <div>
                                            <p className="text-white/50">For the purposes of these Terms and
                                                Conditions:</p>
                                            <ul className="ml-6 list-disc [&>li]:mt-2">
                                                <li>
                                                    <strong>Account</strong><b
                                        ...
                                        <div>
                                            ...
                                            <ul className="ml-6 list-disc [&>li]:mt-2">
                                                <li>
                                                    <strong>Consumer</strong><b
                                                    className="text-white/50 font-medium"> for
                                                    ...
                                                    transitory purpose.</b>
                                                </li>
                                                <li>
                                                    <strong>Cookies</strong><b
                                                    className="text-white/50 font-medium"> are small files that are
                                                    placed
                                                ...
                                                <li>
                                                    ...
                                                    className="text-white/50 font-medium"> refers to: London, United
                                                    Kingdom</b>
                                                </li>
                                                <li>
                                                    <strong>Data Controller</strong><b
                                                    className="text-white/50 font-medium"> for the purposes of the GDPR
                                                    ...
                                                    and
                                                    means of the processing of Personal Data.</b>
                                                </li>
                                                <li>
                                                    <strong>Device</strong><b
                                                    className="text-white/50 font-medium"> means any device that can
                                                    access
                                                    the Service such as a computer, a cellphone or a digital tablet.</b>
                                                </li>
                                                <li>
                                                    <strong>Do Not Track</strong><b
                                                    className="text-white/50 font-medium"> (DNT) is a concept that has
                                                    been
                                                    ...
                                                    tracking of their online activities across websites.</b>
                                                </li>
                                                <li>
                                                    <strong>Personal Data</strong><b
                                                    className="text-white/50 font-medium"> is any information that
                                                    relates
                                                    to an identified or identifiable individual.</b>
                                                </li>
                                            </ul>
                                            <p className="text-white/50">For the purposes for GDPR, Personal Data means
                                                any
                                        ...
                                        <br/>
                                        <div>
                                            <p className="text-white/50">For the purposes of the CCPA, Personal Data
                                                means
                                            ...
                                            <ul className="ml-6 list-disc [&>li]:mt-2">
                                                <li>
                                                    {/* eslint-disable-next-line react/no-unescaped-entities */}
                                                    <strong>Sale</strong><b className="text-white/50 font-medium"> for
                                                    the
                                                ...
                                                <li>
                                                    ...
                                                    className="text-white/50 font-medium"> means any natural or legal
                                                    person
                                                    who processes the data on behalf of the Company. It refers to
                                                    third-party companies or individuals employed by the Company to
                                                    facilitate the Service, to provide the Service on behalf of the
                                                    Company,
                                                    to perform services related to the Service or to assist the Company
                                                    in
                                                    analyzing how the Service is used. For the purpose of the GDPR,
                                                    Service
                                                    Providers are considered Data Processors.</b>
                                                </li>
                                                <li>
                                                    <strong>Third-party Social Media Service</strong><b
                                                    className="text-white/50 font-medium"> refers to any website or any
                                                    social network website through which a User can log in or create an
                                                    account to use the Service.</b>
                                                </li>
                                                <li>
                                                    <strong>Usage data</strong><b
                                                    className="text-white/50 font-medium"> refers to data collected
                                                ...
                                                <li>
                                                    ...
                                                    className="text-white/50 font-medium"> refers to PowerHut, LTD,
                                                    accessible from <a className="text-white underline"
                                                                       href="https://powerhut.pro/">https://powerhut.pro</a></b>
                                                </li>
                                                <li>
                                                    <strong>You</strong><b
                                                    className="text-white/50 font-medium"> means the individual
                                                    accessing or
                                            ...
                                            <p className="text-white/50">Under GDPR (General Data Protection
                                                Regulation),
                                                You can be referred to as the Data Subject or as the User as you are the
                        ...
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="item-1">
                                <AccordionTrigger>Detailed information on the processing of your personal
                        ...
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="item-1">
                                {/* eslint-disable-next-line react/no-unescaped-entities */}
                                <AccordionTrigger>"DO NOT TRACK" policy as required by california online privacy
                                    protection
                                    act (CALOPPA)</AccordionTrigger>
                                <AccordionContent>
                                    <p className="leading-7 mt-6 text-white/50">
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    <p className="leading-7 mt-6 text-white/50">
                                        ...
                                        a
                                        parent, you should know that through the Service children under the age of 13
                                        may
                                        ...
                                        personal
                                        {/* eslint-disable-next-line react/no-unescaped-entities */}
                                        information from a child, the child"s parent receives notice of and consents to
                                        our
                                    ...
                                    <p className="leading-7 mt-6 text-white/50">
                                        ...
                                        provide
                                        certain functionality of the Service to these Users. If We need to rely on
                                        consent
                                    ...
                                    <div className="leading-7 mt-2">
                                        <div>
                                            ...
                                            <p className="leading-7 mt-6 text-white/50">
                                                ...
                                                our
                                                standard Privacy Policy for the disclosure of personal information
                                                collected
                                        ...
                                        <div>
                                            <ul className="ml-6 list-disc [&>li]:mt-2">
                                                <li>
                                                    {/* eslint-disable-next-line react/no-unescaped-entities */}
                                                    <strong>Review, correct or delete the child's personal
                                                        information</strong>
                                                </li>
                                                <li>
                                                    {/* eslint-disable-next-line react/no-unescaped-entities */}
                                                    <strong>Discontinue further collection or use of the child's
                                                        personal
                                                        information</strong>
                                                </li>
                                            </ul>
