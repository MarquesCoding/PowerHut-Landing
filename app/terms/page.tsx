    ...
    return (
        <div className="w-full h-full flex flex-col">
            ...
            <div className="background-br">
                <motion.div
                    className="w-full h-auto flex max mb-24 p-4 lg:p-0">
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    ...
                                    <p className="leading-7 mt-6 text-white/50">
                                        ...
                                        accessing or
                                        using
                                        any part of the site, you agree to be bound by these Terms of Service. If you do
                                        not
                                        agree to all the
                                        terms
                                        ...
                                        <div>
                                            ...
                                            <ul className="ml-6 list-disc [&>li]:mt-2">
                                                ...
                                                <li>
                                                    ...
                                                    className="text-white/50 font-medium"> refers
                                                    to:
                                                    London, United
                                                    Kingdom</b>
                                                </li>
                                                ...
                                                <li>
                                                    <strong>Goods</strong><b
                                                    className="text-white/50 font-medium"> refer to
                                                    the
                                                    items offered for
                                                ...
                                                <li>
                                                    <strong>You</strong><b className="text-white/50 font-medium"> means
                                                    the
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    ...
                                    <p className="leading-7 mt-6 text-white/50">
                                        ...
                                        Application
                                        or the Website
                                        and tells You about Your privacy rights and how the law protects You. Please
                                        read
                                        Our
                                        Privacy Policy
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    ...
                                    <p className="leading-7 mt-4 text-white/50">
                                        ...
                                        renewal
                                        either through
                                        Your online account management page or by contacting the Company customer
                                        support
                                        team.
                                    </p>
                                    ...
                                    <p className="leading-7 mt-4 text-white/50">
                                        You may cancel Your Subscription at any time. You will not receive any refund
                                        for
                                        the
                                        fees You already
                                        paid for Your current Subscription period and You will be able to access the
                                        Service
                                        until the end of
                                    ...
                                    <p className="leading-7 mt-4 text-white/50">
                                        ...
                                        fees.
                                        Any Subscription
                                        fee change will become effective at the end of the then-current Subscription
                                        period.
                                    </p>
                                    <p className="leading-7 mt-4 text-white/50">
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    ...
                                    <p className="leading-7 mt-6 text-white/50">
                                        ...
                                        use, a name or trademark that is subject to any rights of another person or
                                        entity
                                        other
                                        than You
                                        without appropriate authorization, or a name that is otherwise offensive, vulgar
                                        or
                                        obscene.
                                    </p>
                                </AccordionContent>
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    ...
                                    <p className="leading-7 mt-6 text-white/50">
                                        ...
                                        periods of
                                        time or cancel the
                                        service at any time, without notice to you. You expressly agree that your use
                                        of, or
                                        inability to use,
                                        ...
                                        for
                                        your use, without
                                        any representation, warranties or conditions of any kind, either express or
                                        implied,
                                        including all
                            ...
                            <AccordionItem value="item-1">
                                ...
                                <AccordionContent>
                                    ...
                                    <p className="leading-7 mt-6 text-white/50">
                                        ...
                                        or
                                        in respect to
                                        The Service constitutes the entire agreement and understanding between You and
                                        us
                                        and
                                        govern Your use of
                                        the Service, superseding any prior or contemporaneous agreements, communications
                                        and
                                        proposals, whether
                                        oral or written, between You and us (including, but not limited to, any prior
                                        versions
                                        of the Terms of
                                        Service). Any ambiguities in the interpretation of these Terms of Service shall
                                        not
                                        be
                                        construed against
                                        the drafting party.
