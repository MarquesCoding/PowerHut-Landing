...
export default function RootLayout({
  ...
  return (
      ...
      <meta content="Want to play games friends, but don't have a huge budget? We offer the Latest Intel & AMD CPUs at competitive prices." property="twitter:description"/>
