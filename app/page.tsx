            ...
            <motion.div
                ...
                <div className="flex flex-col w-full h-full">
                    ...
                    <div className="background-tr">
                        <div className="flex flex-col justify-center max item-center w-full h-auto pb-24">
                            <div
                                className="mx-auto w-full relative overflow-hidden h-full px-4 flex flex-col">
                                <motion.div>
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <p className="font-light max-w-3xl mb:pb-0">
                                            {/* eslint-disable-next-line react/no-unescaped-entities */}
                                            We want to be transparent as much as possible, including the providers that {' '}
                                            {/* eslint-disable-next-line react/no-unescaped-entities */}
                                            we use. We currently don't own the hardware that we rent out, but have plans
                                            to have colocate.
                                            <br/>
                                            We use Hetzner for our EU servers and Equinix & Reliablesite for our US based
                                            servers. We use backblaze for all of our backups -- which we are planning on migrating over to our own hardware using <a href="https://min.io/" className="text-main underline decoration-dotted">(minIO)</a>.
                                        </p>
                                        <div className="flex flex-row flex-wrap gap-4">
                                            <img className="h-16 rounded"
                                                 src="https://cdn.hetzner.com/assets/Uploads/Hetzner-Logo-slogan_white_space-red.jpg"
                                                 alt="hetzner"/>
                                            <img className="h-16 bg-white px-2 rounded"
                                                 src="https://www.equinix.co.uk/content/experience-fragments/eqxcorp/en_gb/header-standard/header-standard-great-britain/_jcr_content/root/header/logo.coreimg.png/1641511038798/logo.png"
                                                 alt="equinix"/>
                                            <div
                                                className="w-fit px-2 rounded h-16 bg-zinc-900 flex items-center justify-center">
                                                <img className="h-12"
                                                     src={"https://www.reliablesite.net/static/img/minified-svg/logo.svg"}
                                                     alt="reliable-site"/>
                                            </div>
                                            <img className="h-16 px-2 rounded bg-white" src={"https://sm.pcmag.com/t/pcmag_me/review/b/backblaze/backblaze_axkq.1920.jpg"} alt={"back-blaze"}/>
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
                    ...
                    <div className="background-br">
                        <div className="flex flex-col justify-center max item-center w-full h-auto pb-24">
                            <div className="mb-20 flex flex-col gap-4 items-start px-4">
                            ...
                            <div
                                className="flex w-full h-auto flex-wrap gap-6 items-center justify-center lg:justify-start px-4">
                        ...
                        <div className="w-full max h-auto flex flex-col pb-48 px-8 xl:p-8">
                            ...
                            <div className="flex w-full h-auto flex-wrap gap-6 max-w-[100rem]">
                                ...
                                <Card
                                    ...
                                    content={
                                        "Take full control of all of your files 24/7, wherever you are."
                                    }
                                />
                                <Card
                                ...
                                <Card
                                    ...
                                    content={
                                        "We've compiled our best features into one single panel. Plus there are most to come!"
                                    }
                                />
                                <Card
                                ...
                                <div className="flex flex-col xl:flex-row gap-4 w-full">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-4 opacity-80">
                                            ...
                                            to help you guys out! Grafana provides monitoring, logs & statistics for our
                    ...
                    <div className="background-br">
                        <div className="flex max flex-row  py-20 md:h-auto w-full px-8 xl:p-8">
                            <div
                                className="mx-auto w-full relative overflow-hidden h-full md:h-[56rem] px-4 flex flex-col">
                                <motion.div>
                                    <div className="flex flex-col gap-4">
                                        <Button className="w-fit h-fit font-mono text-black" variant="secondary"
                                                size="sm">
                                        ...
                                        <p className="opacity-50 font-light max-w-lg mb:pb-0">
                                            {/* eslint-disable-next-line react/no-unescaped-entities */}
                            ...
                            <div
                                ...
                                >
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <p className="opacity-50 font-light max-w-lg">
                                            {/* eslint-disable-next-line react/no-unescaped-entities */}
                                            Don't worry if you don't right now, you can always throw us a ticket -
                                            either
                                    ...
                                    <div className="w-full flex flex-col gap-4">
                                        ...
                                        <Accordion type="single" collapsible className="w-full">
                                            <AccordionItem value="item-1">
                                                ...
                                                <AccordionContent>
                                                    <p className="leading-7 mt-6 text-white/50">
                                                        Servers are available as soon as your payment has been
                                                        processed,
                                                        typically
                                                        {/* eslint-disable-next-line react/no-unescaped-entities */}
                                        ...
                                        <Accordion type="single" collapsible className="w-full">
                                            <AccordionItem value="item-1">
                                                ...
                                                <AccordionContent>
                                                    <p className="leading-7 mt-6 text-white/50">
                                                        Of course! Feel free to create a ticket on our Discord Server
                                                        and we
                                                        will
                                                        help you out.
                                                    </p>
                                            ...
                                            <AccordionItem value="item-1">
                                                ...
                                                <AccordionContent>
                                                    <p className="leading-7 mt-6 text-white/50">
                                                        ...
                                                        As such, you can expect a fast, lag-free, and secure experience
                                                        to
                                                        take
                                                        care
                                                        {/* eslint-disable-next-line react/no-unescaped-entities */}
                                        ...
                                        <Accordion type="single" collapsible className="w-full">
                                            <AccordionItem value="item-1">
                                                <AccordionTrigger>Which payment methods do you
                                                    accept?</AccordionTrigger>
                                                <AccordionContent>
                                                    <p className="leading-7 mt-6 text-white/50">
                                    ...
                                    <div className="w-full flex flex-col gap-4">
                                        ...
                                        <Accordion type="single" collapsible className="w-full">
                                            <AccordionItem value="item-1">
                                                ...
                                                <AccordionContent>
                                                    <p className="leading-7 mt-6 text-white/50">
                                                        We have servers in Germany & USA with more locations coming
                                                        soon!
                                                    </p>
                                                </AccordionContent>
                                            </AccordionItem>
                                        ...
                                        <Accordion type="single" collapsible className="w-full">
                                            <AccordionItem value="item-1">
                                                ...
                                                <AccordionContent>
                                                    <p className="leading-7 mt-6 text-white/50">
                                                        We can only transfer servers as needed, as it depends on the
                                                        situation
                                                        and
                                                        available stock.
                                                        Feel free to open a ticket with us if you wish to change your
                                                        location!
                                                    </p>
                                                </AccordionContent>
                                            </AccordionItem>
                                        ...
                                        <Accordion type="single" collapsible className="w-full">
                                            <AccordionItem value="item-1">
                                                ...
                                                <AccordionContent>
                                                    <p className="leading-7 mt-6 text-white/50">
                                                        We have a huge variety of supported games such as Minecraft,
                                                        Valheim,
                                        ...
                                        <Accordion type="single" collapsible className="w-full">
                                            <AccordionItem value="item-1">
                                                ...
                                                <AccordionContent>
                                                    <p className="leading-7 mt-6 text-white/50">
                                                        Damn, that sucks for you to go. But no worries. You can request
                                                        a
