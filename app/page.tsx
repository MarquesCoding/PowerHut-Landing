...
export default function Home() {
    ...
    return (
        // <FollowerPointerCard>
        <>
            <motion.div className="w-full h-full flex flex-col max-w-screen">
                <Promo/>
                <motion.div
                    initial={{
                        opacity: 0,
                    ...
                    className="w-full h-[70vh] bg-gradient-to-tr from-[#FF4D14]/10 to-transparent bg-opacity-50 relative"
                >
                    <div
                    ...
                    <div
                        ...
                        >
                            <div
                                className="w-fit h-auto rounded-full mb-4 text-sm text-[#FF4D14] flex items-center justify-center gap-4 py-1 px-2 border border-[#FF4D14]/50 bg-[#FF4D14]/10"
                            >
                    ...
                    <div className="flex w-full h-auto justify-center items-center flex-col">
                        ...
                        <div className="mt-4">
                            <p className="mt-4 mb-3 font-bold">
                                Looking for more prices? These are only our recommendations. Get started with <a
                                href="/plans" className="underline">Server Hosting</a>.
                            </p>
                            <p className="opacity-60 text-center text-white w-full text-xs">*CPU will vary based on
                                server
                ...
                <motion.div
                    ...
                    className="w-full h-auto bg-gradient-to-bl to-[#FF4D14]/10 from-transparent pb-24">
